...
//		}
	...
	private IEnumerator playTurn(){
		...
		Debug.Log ("Player 1 :");
		Hand player1hand = players[0].GetComponentInChildren<Hand>();
		Hand player2hand = players[1].GetComponentInChildren<Hand>();
		Vector3 activeP = player1hand.transform.position + Vector3.zero;
		Quaternion activeR = player1hand.transform.rotation * Quaternion.identity;
		Vector3 passiveP = player2hand.transform.position + Vector3.zero;
		Quaternion passiveR = player2hand.transform.rotation * Quaternion.identity;
		yield return StartCoroutine(players[0].WaitForPlay());
		player1hand.transform.position = passiveP;
		player1hand.transform.rotation = passiveR;
		player2hand.transform.position = activeP;
		player2hand.transform.rotation = activeR;
		player1hand.GetComponentsInChildren<SpriteRenderer>()[1].transform.rotation = Quaternion.identity;
		player2hand.GetComponentsInChildren<SpriteRenderer>()[1].transform.rotation = Quaternion.identity;
		Debug.Log ("Player 2 :");
		yield return StartCoroutine(players[1].WaitForPlay());
		player2hand.transform.position = passiveP;
		player2hand.transform.rotation = passiveR;
		player1hand.transform.position = activeP;
		player1hand.transform.rotation = activeR;
		player1hand.GetComponentsInChildren<SpriteRenderer>()[1].transform.rotation = Quaternion.identity;
		player2hand.GetComponentsInChildren<SpriteRenderer>()[1].transform.rotation = Quaternion.identity;
		players[1].UpdateFingers();
